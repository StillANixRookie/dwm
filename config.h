...
static unsigned int minwsz   = 20;       /* Minimal heigt of a client for smfact */
static int swallowfloating   = 0;        /* 1 means swallow floating windows by default */
static int rmaster           = 1;        /* 1 means master-area is initially on the right */
static int showbar           = 0;        // 0 means no bar
static int topbar            = 1;        // 0 means bottom bar
static char *fonts[]         = { "monospace:size=10" };
static char dmenufont[]      = "monospace 10";
